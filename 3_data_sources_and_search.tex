...
\item different formats of the result set, in some cases was possible to batch-download the results, otherwise results were scraped using Zotero\footnote{https://www.zotero.org/} browser integration.
\end{itemize}
