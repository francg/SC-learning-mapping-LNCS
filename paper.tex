...
\titlerunning{Technology-enhanced SC Learning: a Systematic Mapping of the Literature}
...
\input{2_motivation_and_rq.tex}

\section{Data Sources and Search}
\input{3_data_sources_and_search.tex}

\section{Screening of Papers}
\input{4_screening_of_papers.tex}

\section{Classification and Coding}
\input{5_classification_and_coding.tex}

\section{Results and Findings}
\input{6_results_and_findings.tex}
